...
import org.talchain.util.ExecutorPipeline;
                ...
                public void run() {
                    try {
                        logger.info("Sync state: " + getSyncStatus() +
                                ...
                                Utils.longToTimePeriod(importIdleTime.get()) + " of total " + Utils.longToTimePeriod(System.currentTimeMillis() - importStart)));
                    } catch (Exception e) {
