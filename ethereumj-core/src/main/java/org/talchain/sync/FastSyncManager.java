...
import org.talchain.datasource.DbSource;
import org.talchain.db.DbFlushManager;
import org.talchain.db.IndexedBlockStore;
import org.talchain.db.StateSource;
import org.talchain.facade.SyncStatus;
...
import org.talchain.net.eth.handler.Eth63;
import org.talchain.net.message.ReasonCode;
import org.talchain.net.rlpx.discover.NodeHandler;
...
//                idle.getEthHandler().setStatus(SyncState.IDLE);
    ...
    private EthereumListener.SyncState getSyncStage() {
        ...
        if (bytes == null) return EthereumListener.SyncState.UNSECURE;
...
//        }
    ...
    public void main() {
        ...
        if (blockchain.getBestBlock().getNumber() == 0 || getSyncStage() == EthereumListener.SyncState.SECURE || getSyncStage() == EthereumListener.SyncState.COMPLETE) {
            ...
            try {
                ...
                switch (origSyncStage) {
                    ...
                    case SECURE:
                        if (origSyncStage == EthereumListener.SyncState.SECURE) {
                    ...
                    case COMPLETE:
                        if (origSyncStage == EthereumListener.SyncState.COMPLETE) {
