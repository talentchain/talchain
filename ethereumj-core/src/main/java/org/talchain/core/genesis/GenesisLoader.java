package org.talchain.core.genesis;
...
import static org.talchain.util.ByteUtil.*;
...
public class GenesisLoader {
    ...
    private static Genesis createBlockForJson(GenesisJson genesisJson) {
        ...
        return new Genesis(parentHash, HashUtil.EMPTY_LIST_HASH, coinbase, Genesis.ZERO_HASH_2048,
