...
import static org.talchain.jsonrpc.TypeConverter.*;
import static org.talchain.jsonrpc.TypeConverter.StringHexToByteArray;
import static org.talchain.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.talchain.util.ByteUtil.bigIntegerToBytes;
...
public class JsonRpcImpl implements JsonRpc {
    ...
    public CompilationResult eth_compileSolidity(String contract) throws Exception {
        ...
        try {
            ...
            org.talchain.solidity.compiler.CompilationResult result = org.talchain.solidity.compiler.CompilationResult.parse(res.output);
            CompilationResult ret = new CompilationResult();
            org.talchain.solidity.compiler.CompilationResult.ContractMetadata contractMetadata = result.contracts.values().iterator().next();
