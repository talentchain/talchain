...
import org.talchain.core.genesis.GenesisLoader;
...
import org.talchain.solidity.compiler.CompilationResult;
import org.talchain.solidity.compiler.SolidityCompiler;
...
//        }
    ...
    @Override
	public SolidityContract submitNewContract(CompilationResult.ContractMetadata contractMetaData, Object... constructorArgs) {
	...
	private SolidityContractImpl createContract(String contractName, CompilationResult result) {
		CompilationResult.ContractMetadata cMetaData = result.contracts.get(contractName);
	...
	private SolidityContractImpl createContract(CompilationResult.ContractMetadata contractData) {
