...
import org.talchain.vm.program.Stack;
...
import static org.talchain.vm.OpCode.CALL;
import static org.talchain.vm.OpCode.CALLCODE;
import static org.talchain.vm.OpCode.CREATE;
import static org.talchain.vm.OpCode.DELEGATECALL;
import static org.talchain.vm.OpCode.PUSH1;
        ...
        try {
            ...
            switch (op) {
                ...
                case SHA3: {
                    ...
                    byte[] encoded = HashUtil.sha3(buffer);
                ...
                case DELEGATECALL: {
                    ...
                    MessageCall msg = new MessageCall(
                            MessageCall.MsgType.fromOpcode(op),
