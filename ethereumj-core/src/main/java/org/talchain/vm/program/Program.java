...
import org.talchain.vm.program.listener.CompositeProgramListener;
import org.talchain.vm.program.listener.ProgramListenerAware;
import org.talchain.vm.program.listener.ProgramStorageChangeListener;
import org.talchain.vm.trace.ProgramTraceListener;
...
public class Program {
    ...
    private org.talchain.vm.program.Stack stack;
    ...
    public Program(byte[] codeHash, byte[] ops, ProgramInvoke programInvoke, Transaction transaction, SystemProperties config) {
        ...
        this.stack = setupProgramListener(new org.talchain.vm.program.Stack());
    ...
    public org.talchain.vm.program.Stack getStack() {
        return this.stack;
    }
    ...
    public void createContract(DataWord value, DataWord memStart, DataWord memSize) {
        ...
        if (BIUtil.isNotCovers(getStorage().getBalance(senderAddress), endowment)) {
            stackPushZero();
            return;
        }
    ...
    public void callToAddress(MessageCall msg) {
        ...
        if (BIUtil.isNotCovers(senderBalance, endowment)) {
            stackPushZero();
        ...
        if (isNotEmpty(programCode)) {
            ProgramInvoke programInvoke = programInvokeFactory.createProgramInvoke(
                    ...
                    msg.getType() == MessageCall.MsgType.DELEGATECALL ? getCallerAddress() : getOwnerAddress(),
                    msg.getType() == MessageCall.MsgType.DELEGATECALL ? getCallValue() : msg.getEndowment(),
