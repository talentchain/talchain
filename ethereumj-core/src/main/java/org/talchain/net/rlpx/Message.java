...
import static org.talchain.util.ByteUtil.merge;
...
public abstract class Message {
    ...
    public static Message decode(byte[] wire) {
        ...
        byte[] mdcCheck = HashUtil.sha3(wire, 32, wire.length - 32);
    ...
    public Message encode(byte[] type, byte[] data, ECKey privKey) {
        ...
        byte[] forSig = HashUtil.sha3(payload);
    ...
    public ECKey getKey() {
        ...
        byte[] msgHash = HashUtil.sha3(wire, 97, wire.length - 97);
