...
import org.talchain.net.eth.message.*;
...
import static org.talchain.sync.PeerState.*;
import static org.talchain.sync.PeerState.BLOCK_RETRIEVING;
...
public class Eth62 extends EthHandler {
    ...
    public String getSyncStats() {
        ...
        return String.format(
                ...
                Utils.longToTimePeriod(lifeTime - processingTime),
                Utils.longToTimePeriod(lifeTime),
