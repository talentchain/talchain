...
import org.talchain.config.blockchain.OlympicConfig;
import org.ethereum.config.net.*;
import org.talchain.config.net.*;
import org.talchain.core.Genesis;
import org.talchain.core.genesis.GenesisConfig;
import org.talchain.core.genesis.GenesisJson;
import org.talchain.core.genesis.GenesisLoader;
import org.talchain.crypto.ECKey;
import org.talchain.net.p2p.P2pHandler;
import org.talchain.net.rlpx.MessageCodec;
            ...
            if (configObject.get("url") != null) {
                ...
                if (configObject.toConfig().hasPath("nodeId")) {
                    ...
                    if (configObject.toConfig().hasPath("nodeName")) {
                        ...
                        nodeId = ECKey.fromPrivate(HashUtil.sha3(nodeName.getBytes())).getNodeId();
                    } else {
