...
import org.talchain.datasource.CountingBytesSource;
import org.talchain.datasource.JournalSource;
...
import static org.talchain.util.ByteUtil.intToBytes;
...
//        System.out.println("Gen root: " + Hex.toHexString(bc.getBlockchain().getBestBlock().getStateRoot()));
        ...
        bc.sendEther(alice.getAddress(), EtherUtil.convert(3, EtherUtil.Unit.ETHER));
        ...
        bc.sendEther(bob.getAddress(), EtherUtil.convert(5, EtherUtil.Unit.ETHER));
        bc.createBlock();
        ...
        Assert.assertEquals(EtherUtil.convert(30, EtherUtil.Unit.ETHER), bc.getBlockchain().getRepository().getBalance(alice.getAddress()));
        Assert.assertEquals(EtherUtil.convert(50, EtherUtil.Unit.ETHER), bc.getBlockchain().getRepository().getBalance(bob.getAddress()));

        {
            ...
            Assert.assertEquals(EtherUtil.convert(3 * 9, EtherUtil.Unit.ETHER), r1.getBalance(alice.getAddress()));
            Assert.assertEquals(EtherUtil.convert(5 * 9, EtherUtil.Unit.ETHER), r1.getBalance(bob.getAddress()));
        }

        {
            Block b1 = bc.getBlockchain().getBlockByNumber(bestBlockNum - 2);
            Repository r1 = bc.getBlockchain().getRepository().getSnapshotTo(b1.getStateRoot());
            Assert.assertEquals(EtherUtil.convert(3 * 8, EtherUtil.Unit.ETHER), r1.getBalance(alice.getAddress()));
            Assert.assertEquals(EtherUtil.convert(5 * 8, EtherUtil.Unit.ETHER), r1.getBalance(bob.getAddress()));
        }

        {
            Block b1 = bc.getBlockchain().getBlockByNumber(bestBlockNum - 3);
            Repository r1 = bc.getBlockchain().getRepository().getSnapshotTo(b1.getStateRoot());
            Assert.assertEquals(EtherUtil.convert(3 * 7, EtherUtil.Unit.ETHER), r1.getBalance(alice.getAddress()));
            Assert.assertEquals(EtherUtil.convert(5 * 7, EtherUtil.Unit.ETHER), r1.getBalance(bob.getAddress()));
        }
