...
import static org.talchain.util.blockchain.EtherUtil.Unit.ETHER;
import static org.talchain.util.blockchain.EtherUtil.convert;
...
//        public BlockingQueue<Triple<TransactionReceipt, PendingTransactionState, Block>> onPendingTransactionUpdate = new LinkedBlockingQueue<>();
    ...
    public void testSimple() throws InterruptedException {
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx1), EthereumListener.PendingTransactionState.DROPPED);
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx1_), EthereumListener.PendingTransactionState.DROPPED);
        ...
        Assert.assertEquals(txUpd.getMiddle(), EthereumListener.PendingTransactionState.NEW_PENDING);
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx2), EthereumListener.PendingTransactionState.PENDING);
        Assert.assertEquals(l.pollTxUpdateState(tx3), EthereumListener.PendingTransactionState.PENDING);

        bc.submitTransaction(tx2);
        Block b3 = bc.createBlock();

        txUpd = l.pollTxUpdate(tx2);
        Assert.assertEquals(txUpd.getMiddle(), EthereumListener.PendingTransactionState.INCLUDED);
        ...
        for (int i = 0; i < SystemProperties.getDefault().txOutdatedThreshold() + 1; i++) {
            bc.createBlock();
            txUpd = l.pollTxUpdate(tx3);
            if (txUpd.getMiddle() != EthereumListener.PendingTransactionState.PENDING) break;
        }

        // tx3 dropped due to timeout
        Assert.assertEquals(txUpd.getMiddle(), EthereumListener.PendingTransactionState.DROPPED);
    ...
    public void testRebranch1() throws InterruptedException {
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx1), EthereumListener.PendingTransactionState.NEW_PENDING);
        Assert.assertEquals(l.pollTxUpdateState(tx2), EthereumListener.PendingTransactionState.NEW_PENDING);
        Assert.assertTrue(pendingState.getRepository().getBalance(alice.getAddress()).
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx1), EthereumListener.PendingTransactionState.INCLUDED);
        Assert.assertEquals(l.pollTxUpdateState(tx2), EthereumListener.PendingTransactionState.PENDING);
        Assert.assertTrue(pendingState.getRepository().getBalance(alice.getAddress()).
                compareTo(BigInteger.valueOf(2000000)) == 0);
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx2), EthereumListener.PendingTransactionState.INCLUDED);
        Assert.assertTrue(pendingState.getRepository().getBalance(alice.getAddress()).
                compareTo(BigInteger.valueOf(2000000)) == 0);
        ...
        Assert.assertEquals(l.pollTxUpdateState(tx1), EthereumListener.PendingTransactionState.PENDING);
    ...
    public void testRebranch2() throws InterruptedException {
        ...
        Assert.assertTrue(l.getQueueFor(tx2).isEmpty());
        Assert.assertEquals(l.pollTxUpdateState(tx3), EthereumListener.PendingTransactionState.PENDING);
        Assert.assertEquals(l.pollTxUpdateState(tx4), EthereumListener.PendingTransactionState.PENDING);
        Assert.assertTrue(pendingState.getRepository().getBalance(alice.getAddress()).
                compareTo(BigInteger.valueOf(4000000)) == 0);
        ...
        Assert.assertEquals(txUpd.getRight(), b3);
        Assert.assertTrue(l.getQueueFor(tx2).isEmpty());
        Assert.assertEquals(l.pollTxUpdateState(tx3), EthereumListener.PendingTransactionState.INCLUDED);
        Assert.assertEquals(l.pollTxUpdateState(tx4), EthereumListener.PendingTransactionState.INCLUDED);
        Assert.assertTrue(pendingState.getRepository().getBalance(alice.getAddress()).
                compareTo(BigInteger.valueOf(4000000)) == 0);
    }
