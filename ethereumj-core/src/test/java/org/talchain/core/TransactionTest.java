...
import org.talchain.crypto.ECKey.MissingPrivateKeyException;
...
import org.talchain.solidity.SolidityType;
        ...
        List<String> res = new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
            ...
            protected ProgramResult executeTransaction(Transaction tx) {
...

                {
                    ...
                    System.out.println("Return value: " + new SolidityType.IntType("uint").decode(executor.getResult().getHReturn()));
                }
