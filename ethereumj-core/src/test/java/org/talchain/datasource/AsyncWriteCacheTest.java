...
import org.talchain.db.SlowHashMapDb;
...
import static org.talchain.util.ByteUtil.intsToBytes;
...
public class AsyncWriteCacheTest {
    ...
    public void highLoadTest1() throws InterruptedException {
        ...
        stateSource.put(HashUtil.sha3(intToBytes(1)), intToBytes(1));
        stateSource.put(HashUtil.sha3(intToBytes(2)), intToBytes(2));
        ...
        Thread.sleep(100);
        System.out.println("Get...");
        byte[] bytes1 = stateSource.get(HashUtil.sha3(intToBytes(1)));
        System.out.println("Get!: " + bytes1);
        byte[] bytes2 = stateSource.get(HashUtil.sha3(intToBytes(2)));
