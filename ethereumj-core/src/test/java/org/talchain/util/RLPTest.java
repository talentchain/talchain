...
import static org.talchain.util.ByteUtil.byteArrayToInt;
...
//        2240089100000070
    ...
    public void testRlpEncode() {
        ...
        Assert.assertEquals(RlpTestData.result01, Hex.toHexString(RLP.encode(RlpTestData.test01)));
        Assert.assertEquals(RlpTestData.result02, Hex.toHexString(RLP.encode(RlpTestData.test02)));
        Assert.assertEquals(RlpTestData.result03, Hex.toHexString(RLP.encode(RlpTestData.test03)));
        Assert.assertEquals(RlpTestData.result04, Hex.toHexString(RLP.encode(RlpTestData.test04)));
        Assert.assertEquals(RlpTestData.result05, Hex.toHexString(RLP.encode(RlpTestData.test05)));
        Assert.assertEquals(RlpTestData.result06, Hex.toHexString(RLP.encode(RlpTestData.test06)));
        Assert.assertEquals(RlpTestData.result07, Hex.toHexString(RLP.encode(RlpTestData.test07)));
        Assert.assertEquals(RlpTestData.result08, Hex.toHexString(RLP.encode(RlpTestData.test08)));
        Assert.assertEquals(RlpTestData.result09, Hex.toHexString(RLP.encode(RlpTestData.test09)));
        Assert.assertEquals(RlpTestData.result10, Hex.toHexString(RLP.encode(RlpTestData.test10)));
        Assert.assertEquals(RlpTestData.result11, Hex.toHexString(RLP.encode(RlpTestData.test11)));
        Assert.assertEquals(RlpTestData.result12, Hex.toHexString(RLP.encode(RlpTestData.test12)));
        Assert.assertEquals(RlpTestData.result13, Hex.toHexString(RLP.encode(RlpTestData.test13)));
        Assert.assertEquals(RlpTestData.result14, Hex.toHexString(RLP.encode(RlpTestData.test14)));
        Assert.assertEquals(RlpTestData.result15, Hex.toHexString(RLP.encode(RlpTestData.test15)));
        Assert.assertEquals(RlpTestData.result16, Hex.toHexString(RLP.encode(RlpTestData.test16)));
    }
    ...
    public void testRlpDecode() {
        ...
        emptyString = (String) RLP.decode(Hex.decode(RlpTestData.result01), pos).getDecoded();
        assertEquals("", emptyString);

        emptyString = (String) RLP.decode(Hex.decode(RlpTestData.result02), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test02, emptyString);

        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result03), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test03, bytesToAscii(decodedData));

        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result04), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test04, bytesToAscii(decodedData));

        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result05), pos).getDecoded();
        Assert.assertEquals(RlpTestData.test05, bytesToAscii(decodedData));

        decodedList = (Object[]) RLP.decode(Hex.decode(RlpTestData.result06), pos).getDecoded();
        ...
        decodedList = (Object[]) RLP.decode(Hex.decode(RlpTestData.result07), pos).getDecoded();
        ...
        // 1
        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result08), pos).getDecoded();
        assertEquals(RlpTestData.test08, byteArrayToInt(decodedData));

        // 10
        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result09), pos).getDecoded();
        assertEquals(RlpTestData.test09, byteArrayToInt(decodedData));

        // 100
        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result10), pos).getDecoded();
        assertEquals(RlpTestData.test10, byteArrayToInt(decodedData));

        // 1000
        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result11), pos).getDecoded();
        assertEquals(RlpTestData.test11, byteArrayToInt(decodedData));

        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result12), pos).getDecoded();
        assertTrue(RlpTestData.test12.compareTo(new BigInteger(1, decodedData)) == 0);

        decodedData = (byte[]) RLP.decode(Hex.decode(RlpTestData.result13), pos).getDecoded();
        ...
        Object testObject1 = RLP.decode(Hex.decode(RlpTestData.result14), pos).getDecoded();
        assertTrue(DeepEquals.deepEquals(RlpTestData.expected14, testObject1));

        Object testObject2 = RLP.decode(Hex.decode(RlpTestData.result15), pos).getDecoded();
        assertTrue(DeepEquals.deepEquals(RlpTestData.test15, testObject2));

        // Need to test with different expected value, because decoding doesn't recognize types
        Object testObject3 = RLP.decode(Hex.decode(RlpTestData.result16), pos).getDecoded();
    ...
    public void partialDataParseTest() {
        ...
        RLPList el = (RLPList) RLP.decode2OneItem(Hex.decode(hex), 3);
        assertEquals(1, el.size());
        Assert.assertEquals(0, Util.rlpDecodeInt(el.get(0)));
    }
    ...
    public void shortStringRightBoundTest(){
        ...
        byte[] rlpEncoded = RLP.encode(testString);
        String res = new String((byte[]) RLP.decode(rlpEncoded, 0).getDecoded());
