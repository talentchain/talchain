...
public class InternalTransactionTest {
    ...
    public void testRlpEncoding() {
        ...
        Assert.assertArrayEquals(nonce, tx.getNonce());
        Assert.assertArrayEquals(gasPrice.getData(), tx.getGasPrice());
        Assert.assertArrayEquals(gasLimit.getData(), tx.getGasLimit());
        assertArrayEquals(sendAddress, tx.getSender());
        Assert.assertArrayEquals(receiveAddress, tx.getReceiveAddress());
        Assert.assertArrayEquals(value, tx.getValue());
