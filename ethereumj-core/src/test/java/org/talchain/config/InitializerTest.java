...
import org.talchain.util.FileUtil;
...
public class InitializerTest {
    ...
    public void helper_shouldCreateVersionFile_whenOldVersion() {
        ...
        SystemProperties props2 = withConfig(2, Initializer.DatabaseVersionHandler.Behavior.IGNORE);
    ...
    public void helper_shouldStop_whenNoVersionFileAndNotFirstVersion() throws IOException {
        SystemProperties props = withConfig(2, Initializer.DatabaseVersionHandler.Behavior.EXIT);
        resetHelper.process(props);
    ...
    public void helper_shouldReset_whenDifferentVersionAndFlag() {
        ...
        SystemProperties props2 = withConfig(2, Initializer.DatabaseVersionHandler.Behavior.RESET);
        resetHelper.process(props2);
    ...
    public void helper_shouldExit_whenDifferentVersionAndFlag() {
        ...
        final SystemProperties props2 = withConfig(2, Initializer.DatabaseVersionHandler.Behavior.EXIT);
        resetHelper.process(props2);
    }
    ...
    public void helper_shouldIgnore_whenDifferentVersionAndFlag() {
        final SystemProperties props1 = withConfig(1, Initializer.DatabaseVersionHandler.Behavior.EXIT);
        resetHelper.process(props1);
        final File testFile = createFile();

        final SystemProperties props2 = withConfig(2, Initializer.DatabaseVersionHandler.Behavior.IGNORE);
        resetHelper.process(props2);
