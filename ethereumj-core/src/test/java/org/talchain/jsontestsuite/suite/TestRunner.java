...
import org.talchain.core.PendingStateImpl;
import org.talchain.core.Repository;
import org.talchain.datasource.inmem.HashMapDB;
import org.ethereum.db.*;
import org.talchain.db.*;
import org.talchain.jsontestsuite.suite.builder.BlockBuilder;
import org.talchain.jsontestsuite.suite.builder.RepositoryBuilder;
import org.talchain.jsontestsuite.suite.model.BlockTck;
import org.talchain.jsontestsuite.suite.validators.BlockHeaderValidator;
import org.talchain.jsontestsuite.suite.validators.RepositoryValidator;
import org.talchain.listener.EthereumListenerAdapter;
import org.talchain.util.ByteUtil;
import org.talchain.validator.DependentBlockHeaderRuleAdapter;
import org.talchain.vm.DataWord;
import org.talchain.vm.LogInfo;
import org.talchain.vm.VM;
import org.talchain.vm.program.Program;
import org.talchain.vm.program.invoke.ProgramInvoke;
import org.talchain.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.talchain.vm.program.invoke.ProgramInvokeImpl;
import org.talchain.vm.trace.ProgramTrace;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.spongycastle.util.encoders.Hex;
import org.talchain.crypto.HashUtil;
import org.talchain.vm.VMUtils;
...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestCase testCase) {
        ...
        for (Block block : blockTraffic) {
            ...
            logger.debug("{} ~ {} difficulty: {} ::: {}", block.getShortHash(), HashUtil.shortHash(block.getParentHash()),
    ...
    public List<String> runTestCase(TestCase testCase) {
        ...
        try {
            ...
            VMUtils.saveProgramTraceFile(SystemProperties.getDefault(), testCase.getName(), content);
            ...
            if (testCase.getPost() == null) {
                ...
                List<org.talchain.vm.CallCreate> resultCallCreates =
                        program.getResult().getCallCreateList();

                // assert call creates
                for (int i = 0; i < testCase.getCallCreateList().size(); ++i) {

                    org.talchain.vm.CallCreate resultCallCreate = null;
...
//          repository.close();
    ...
    public org.talchain.core.Transaction createTransaction(Transaction tx) {
        ...
        org.talchain.core.Transaction transaction = new org.talchain.core.Transaction(
