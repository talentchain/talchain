package org.talchain.net.swarm;

import org.talchain.net.rlpx.Node;
import org.talchain.net.swarm.bzz.BzzMessage;
import org.talchain.net.swarm.bzz.BzzProtocol;
import org.talchain.net.swarm.bzz.PeerAddress;
import org.talchain.util.ByteUtil;
import org.talchain.util.Functional;
    ...
    public static class TestPeer {
        ...
        public TestPeer(int num) {
            this(new PeerAddress(new byte[]{0, 0, (byte) ((num >> 8) & 0xFF), (byte) (num & 0xFF)}, 1000 + num,
                    HashUtil.sha3(new byte[]{(byte) ((num >> 8) & 0xFF), (byte) (num & 0xFF)})), "" + num);
        }
...
//        Chunk chunk = new Chunk(key, new byte[] {0,0,0,0,0,0,0,0, 77, 88});
        ...
        for (int i = 0; i < chunks.length; i++) {
            Key key = new Key(HashUtil.sha3(new byte[]{0x22, (byte) (i+shift)}));
